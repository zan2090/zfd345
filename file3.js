...
function GetMoveFromString(moveString) {
    ...
    for (var i = 0; i < moves.length; i++) {
        if (GetMoveSAN(moves[i]) == moveString) {
            return moves[i];
        }
    }
...
var materialTable = [0, 700, 2800, 4000, 4000, 11200, 600000];
...
[ 
    -60, -30, -10, 20, 20, -10, -30, -60,
     60,  90, 110,150,150, 110,  90,  60,
    -60, -30, -10, 20, 20, -10, -30, -60,
    -60, -30, -10, 20, 20, -10, -30, -60,
    -60, -30, -10, 20, 20, -10, -30, -60,
    -60, -30, -10, 20, 20, -10, -30, -60,
    -60,  30,  10, 20, 20,  20,  30, -60,
      0,   0,  20, 40, 40,  20,   0,   0
];

var kingAdj =
    [  50, 250, -25, -125, -125, -25, 250, 50,
       50, 150, -50, -125, -125, -25, 150, 50,
       50, 150, -50, -125, -125, -50, 150, 50,
       50, 150, -50,    0,    0, -50, 150, 50,
       50, 150, -50,    0,    0, -50, 150, 50,
       50, 150, -50, -125, -125, -50, 150, 50,
       50, 150, -50, -125, -125, -50, 150, 50,
      150, 250,  75,  -25,  -25,  75, 300, 150
     ];
